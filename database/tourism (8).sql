...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 19, 2024 at 02:40 AM
...
(63, 10, 1, '09054604913', 23, '2024-11-06', '2024-11-02 16:01:19', 3, 0),
(64, 10, 1, '09054604913', 0, '2024-11-06', '2024-11-04 09:08:14', 2, 0);
...
(3, 'Tourist Boat Fees'),
(4, 'Activity Fees'),
(5, 'Accommodation and Food Costs'),
(6, 'Souvenir and Shopping Fees'),
(7, 'Parking Fees'),
(8, 'Guided Tour Fees');
...
(74, 1, 'Buenos Aires Mountain Resort', '../upload/QRcodes/Buenos Aires Mountain Resort.png', '2024-10-21 17:28:23', '2024-10-21 17:28:23');
...
INSERT INTO `review_rating` (`id`, `tour_id`, `user_id`, `rating`, `review`, `img`, `date_created`) VALUES
(20, 1, 10, 5, 'asdasdas', '', '2024-11-19 09:21:59'),
(21, 9, 10, 5, 'qweqwdqw', '', '2024-11-19 09:25:39');
...
(74, 10, '1731969455_Travel app UI.jfif', 'asdas', 'Manokan, Ilijan, 6101, Bago City, Negros Occidental, Philippines', '10.518386492310356', '122.89818609305507', 'Beach Resort', 'asdasdasd', '', 0, 'Environmental Compliance Certificate (ECC),Barangay Clearance', '1731969455_Tan Juan Monument.png', '1', 1, '2024-11-19 06:37:35', NULL);
...
(28, 'default.png', 'owner owner', 'owner', '$2y$10$Z7G01WznGDLJSqOWkMGzae.T08fRh.LIcrfr.yZir.NwCv32dwHNy', 'owner@gmail.com', NULL, 'Barangay Gwe, Talisay City, Negros Occidental', 'owner', '0d930107bae984a115472005837fa5ac', '2024-09-24 03:26:01'),
...
--
ALTER TABLE `fee_categories`
  ADD CONSTRAINT `fee_categories_ibfk_1` FOREIGN KEY (`fee_type_id`) REFERENCES `fee_types` (`id`),
  ADD CONSTRAINT `fee_categories_ibfk_2` FOREIGN KEY (`tour_id`) REFERENCES `tours` (`id`);
