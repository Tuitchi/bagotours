...
<head>
    ...
    <style>
        ...
        .reason-text {
            font-size: 14px;
            color: #6c757d;
            /* Neutral gray for the reason text */
        }
                    ...
                    case 'Pending':
                        ...
                        <div class="announcement-card">
                            ...
                            <div class="status-indicator">
                                <img src="assets/pending.png" alt="Waiting" class="waiting-image">
                                <p class="approval">
                                    Awaiting Approval
                                </p>
                            </div>
                    ...
                    case 'Rejected':
                        ...
                        <div class="rejection-card">
                            ...
                            <p class="rejection-subtext">
                                ...
                                Please review the requirements and resubmit or edit the form within 3 days. After this period, the
                                form will be void.
                            </p>
                            ...
                            <div class="rejection-reason">
                                ...
                                <p class="reason-text">
                                    <?= htmlspecialchars($status['reason']); ?>
                                </p>
                            </div>

                            <form action="resubmit-form.php" method="GET">
                                <input type="hidden" name="tour_id" value="<?= htmlspecialchars($tour_id); ?>">
                                <input type="hidden" name="user_id" value="<?= htmlspecialchars($user_id); ?>">
                                <button type="submit" class="rejection">Edit your form</button>
                            </form>
                        </div>
